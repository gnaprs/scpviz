                        ...
                        children=[
                            dcc.Tab(
                                ...
                                children=[
                                    ...
                                    html.Button(
                                        ...
                                        id="btn-download-import-table",
                                        n_clicks=0,
                                        style={**BUTTON_SUBTLE_STYLE, "marginLeft": "10px"},
                                        title="Exports pdata.summary (per-sample metrics and metadata). Filenames differ by tab; content reflects the dataset state when you click.",
                                    ),
                            ...
                            dcc.Tab(
                                ...
                                children=[
                                    ...
                                    html.Button(
                                        "Download sample summary (CSV)",
                                        id="btn-download-qc-table",
                                        n_clicks=0,
                                        style={**BUTTON_SUBTLE_STYLE, "marginLeft": "10px"},
                                        title="Same table type as Import (pdata.summary), typically after QC filters or plot refresh. Saved as qc_summary.csv.",
                                    ),
                            ...
                            dcc.Tab(
                                ...
                                children=[
                                    ...
                                    html.Button(
                                        "Download sample summary (CSV)",
                                        id="btn-download-prep-table",
                                        n_clicks=0,
                                        style={**BUTTON_SUBTLE_STYLE, "marginLeft": "10px"},
                                        title="Same table type as Import/QC (pdata.summary); use after preprocessing so exports match the current normalized/imputed state. Saved as preprocess_summary.csv.",
                                    ),
