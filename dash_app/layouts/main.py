                        ...
                        children=[
                            ...
                            dcc.Tab(
                                ...
                                children=[
                                    ...
                                    dcc.Textarea(id="de-group1", value='{"cellline":"BE","condition":"kd"}', style={**INPUT_STYLE, "width": "48%", "height": "80px"}),
                                    html.Label("Group 2 filter (JSON object)", style=LABEL_STYLE),
                                    dcc.Textarea(id="de-group2", value='{"cellline":"BE","condition":"sc"}', style={**INPUT_STYLE, "width": "48%", "height": "80px"}),
                                    html.Div(style=SECTION_STYLE),
                                    ...
                                    dcc.Loading(dcc.Graph(id="de-volcano"), type="circle", color=COLORS["brand"], style=LOADING_STYLE),
