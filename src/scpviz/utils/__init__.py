...
Functions:
    ...
    compute_peptide_properties: Compute local / Biopython peptide metrics from sequences.
    get_peptide_properties: Compute peptide biophysical metrics and annotate ``.pep.var``.
